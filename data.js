...
//Sort Planet Name
myData.results.sort(function (a, b) {
...
//Sort by lowest rotation period
myData.results.sort(function (a, b) {
   return a.rotation_period - b.rotation_period;
});
//Sort by highest rotation period
myData.results.sort(function (a, b) {
   return a.rotation_period + b.rotation_period;
});
//Sort by lowest Diameter
myData.results.sort(function (a, b) {
